...
/*
 * TODO Make the following configurable from Vassal Config
 * Brent Easton  18 Aug 2017 Hard-code a limit on string.rep replication size to prevent scripts using ("x"):rep(2^30)  as a DOS attack
...
static int str_rep (lua_State *L) {
  ...
  if (n <= 0) lua_pushliteral(L, "");
	...
	//
	// Brent Easton. Hard-code a limit of 100 for the replication argument
...
static int str_find_aux (lua_State *L, int find) {
	matchSteps = 0;	// Brent Easton 19/8/17
  size_t ls, lp;
